<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="advisorLogin.aspx.cs" Inherits="Advising_System.Login" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <p>
            ...
            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="advisorRegister.aspx">Register</asp:HyperLink>
        </p>
        <div id="backButton">
